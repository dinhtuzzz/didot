...
while logged_in == False:
    ...
    if login_username != "dinhtu":       
        print(Fore.BLUE + Style.BRIGHT + "Username Invalid" + Style.RESET_ALL)
    else:
        login_password = input("⚡Password : ")
        if login_password == "2007":
            print(Fore.GREEN + "Success" + Style.RESET_ALL)            
            logged_in = True
        else:
            print(Fore.YELLOW + "Incorrect Password!" + Style.RESET_ALL)
...
def inputf():
  ...
  ╔═══[Input@Nguyen Dinh Tu Yeu Em O Moi Vu Tru:3]
  ╚══> ''', True), end=' ')
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.blue_to_green, f'''
    ...
    ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        - credit               |         Thông tin 
              ...
              ©Nguyen Dinh Tu Yeu Em O Moi Vu Tru:3
  ...
  while True:
    ...
    if 'credit' in cmdl:
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        - Bản quyền            : Nguyen Dinh Tu
        - ZALO                 : 0929626616
                     Thanks For Use Tool DDoS
